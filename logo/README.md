...
waiting, as in the type `[3]a` of a resource that becomes usable after three
ticks.
...
Colours: time blue `#3298dc`, ink `#24292e`, ring track `#cfe6f8` (dark
variant: paper `#fbfaf7`, track `#4b5563`). The blue is the `is-info` blue of
the Bulma stylesheet the web interface uses, e.g. for its run button.
